...
void HAL_LPTIM_MspInit(LPTIM_HandleTypeDef* lptimHandle)
{
  ...
  /* USER CODE END LPTIM2_MspInit 0 */
    ...
    */
    ...
    PB9     ------> LPTIM2_IN1
    */
    GPIO_InitStruct.Pin = PULSE_CH2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF13_LPTIM2;
    HAL_GPIO_Init(PULSE_CH2_GPIO_Port, &GPIO_InitStruct);
...
void HAL_LPTIM_MspDeInit(LPTIM_HandleTypeDef* lptimHandle)
{
  ...
  /* USER CODE END LPTIM1_MspDeInit 0 */
    ...
    PA0     ------> LPTIM1_IN1
    */
    HAL_GPIO_DeInit(PULSE_CH1_GPIO_Port, PULSE_CH1_Pin);
  ...
  /* USER CODE END LPTIM2_MspDeInit 0 */
    ...
    PB9     ------> LPTIM2_IN1
    */
    HAL_GPIO_DeInit(PULSE_CH2_GPIO_Port, PULSE_CH2_Pin);
